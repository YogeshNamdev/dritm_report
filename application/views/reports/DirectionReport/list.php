  ...
  <script>
    ...
    }else if(issue.replace(/ /gi , "") == 0)
    {
    ...
    else
      {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"app/reports/add_details_of_direction_resolutions",
            data: formData,
            dataType: "json",
            processData: false,
            contentType: false,
...
function Update_details()
    ...
    }else if(officer_mobile_no <= 0)
    {
    ...
    else
      {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"app/reports/update_details_of_direction_resolutions",
            data: formData,
            dataType: "json",
            processData: false,
            contentType: false,
    ...
    function get_all_details(preserveTableState)
    {
     ...
     var base_url = '<?php echo base_url(); ?>';
         $.ajax({
                 type: "POST",
                 dataType: "JSON",
                 url: base_url+"app/reports/get_all_direction_details",
