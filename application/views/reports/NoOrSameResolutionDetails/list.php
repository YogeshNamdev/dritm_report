            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">No Resolution / Same Resolution Report</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <!-- Heading -->
            <h5 class="m-0">
                <b>No Resolution / Same Resolution Report</b>
            </h5>

            <!-- Right Side Controls -->
            <div class="d-flex align-items-center">

                <?php if(in_array($_SESSION["userdata"]["role_id"], array(1, 3 ,2 ,4))): ?>
          ...
          <div class="card-body">
            <ul class="nav nav-tabs mb-3" id="shift_tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);" data-shift="morning" onclick="setShift('morning', this);">Morning Shift</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0);" data-shift="evening" onclick="setShift('evening', this);">Evening Shift</a>
                </li>
            </ul>
            ...
            <form id="report_details" method="post" enctype= "multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    if($district_list != FALSE)
                        ...
                        {
                        echo "<option value='".$districtlist->District_Code."'>".$districtlist->District_Name_E."</option>";
                        }
                        }
                    ?>
                    </select>
                ...
                <div class="form-group">
                    <label>Issue</label>
                    <select class="form-control select2" id="issue" name="issue">
                    <option value="0">-- Select --</option>
                    <?php
                    if($issue_list != FALSE)
                        {
                        ...
                        {
                        echo "<option value='".$issuelist->id."'>".$issuelist->issue."</option>";
                        }
                        }
                    ?>
                    </select>
 ...
 <div class="modal fade" id="update_detail_model">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
            <form id="update_report_details" method="post" enctype= "multipart/form-data" >
                <input type="hidden" name="hidden_id" id="hidden_id" required>
                <div class="form-group">
                    <label>Help-Desk Remark</label>
                        <select class="form-control select2" id="helpdesk_remark" name="helpdesk_remark" onchange="chage_remarks(this.value);">
                            <option value="0">-- Select --</option> 
                            <option value="L1 Officer call done">L1 Officer call done</option>
                            <option value="Ringing">Ringing</option>
                            <option value="Switch off">Switch off</option>
                ...
                <div class="form-group other_remark_div" style="display:none;">
                    ...
                    <textarea name="other_remark" id="other_remark" class="form-control" required></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="officer_mobile_no" id="officer_mobile_no"
                            class="form-control"
                            required>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary" id="au_btn" onclick="Update_details();">Update</button>
            </div>
          </div>
  ...
  <script>
    ...
    }else if(issue.replace(/ /gi , "") == 0)
    {
    ...
    else
      {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"app/reports/add_details_of_no_same_resolutions",
            data: formData,
            dataType: "json",
            processData: false,
            contentType: false,
...
function Update_details()
    ...
    }else if(helpdesk_remark.replace(/ /gi , "") == "0")
    {
    ...
    }else if(officer_mobile_no <= 0)
    {
    ...
    else
      {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"app/reports/update_details_of_no_or_same_resolutions",
            data: formData,
            dataType: "json",
            processData: false,
            contentType: false,
    ...
    function get_all_details(preserveTableState)
    {
     ...
     var base_url = '<?php echo base_url(); ?>';
         $.ajax({
                 type: "POST",
                 dataType: "JSON",
                 url: base_url+"app/reports/get_all_no_same_resolution_details",
